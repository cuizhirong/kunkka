...
/***/ function(module, exports, __webpack_require__) {
	...
	ReactDOM.render(React.createElement(__webpack_require__(159)), document.getElementById('loginForm'));
	...
	var Login = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            'form',
	            { method: 'POST', onSubmit: this.doSubmit, ref: 'loginForm' },
	            React.createElement('span', { className: 'email-icon' }),
	            React.createElement('input', { name: 'email', id: 'id_email', type: 'text', autofocus: 'autofocus', placeholder: '邮箱或用户名', className: 'email' + (this.state.usernameError ? ' error' : ''), tabIndex: '1', onChange: this.onEmailChange, value: this.state.username }),
	            React.createElement('span', { className: 'password-icon' }),
	            React.createElement('input', { name: 'password', id: 'id_password', placeholder: '密码', type: 'password', className: 'password' + (this.state.passwordError ? ' error' : ''), tabIndex: '2', onChange: this.onPwdChange, value: this.state.password }),
	            React.createElement(
	                'div',
	                { className: 'tip' },
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        'a',
	                        { href: 'https://www.ustack.com/accounts/password/reset/ ', target: '_blank' },
	                        '忘记密码?'
	                    )
	                )
	            ),
	            React.createElement('input', { type: 'submit', className: 'submit', value: '登录' })
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventEmitter = __webpack_require__(161);
	...
	var Model = (function (_EventEmitter) {
	    ...
	    function Model() {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(Model).call(this));
	    }
...
/***/ }
/******/ ]);
//# sourceMappingURL=main-login.min.js.map