...
class SelectData extends React.Component {
  constructor(props) {
    ...
    this.state = {
      phoneValue: props.phoneValue ? props.phoneValue : ''
    };
  ...
  render() {
    return (
      <select className="select hide input-area" onChange={this.onPhoneChange} value={this.state.phoneValue}>
        ...
        <option value="850">Korea Dem Peoples Rep(+850)</option>
