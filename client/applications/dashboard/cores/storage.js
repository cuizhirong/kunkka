...
var heat = require('../modules/heat-list/cache');
var resourcetype = require('../modules/resource-type/cache');
...
Object.assign(Storage.prototype, instance, image, port, floatingip, keypair, network, router, securitygroup,
  ...
  ipsecpolicy, notification, alarm, heat, resourcetype, templateversion);
