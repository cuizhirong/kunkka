    ...
    reader.onload = function() {
      ...
      request.validate(data).then(res => {
        if (props.obj && props.obj.type === 'preview') {
          let url = '/proxy-swift/v1/AUTH_' + HALO.configs.adminProjectId + '/' + HALO.user.projectId + '_template' + '/' + file.name;
      ...
      if (state.type === 'file') {
        ...
        switch(state.type) {
          case 'url':
            ...
            break;
          case 'template':
            data.template_url = HALO.configs.swift_url + '/v1/AUTH_' + HALO.configs.adminProjectId + '/' + HALO.user.projectId + '_template' + '/' + state.templateValue;
            break;
          case 'direct_input':
