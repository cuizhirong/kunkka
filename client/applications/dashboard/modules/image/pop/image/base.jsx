...
class ImageBase extends React.Component {
  ...
  render() {
    ...
    return (
      <Modal refs="modal"
        {...props}
        title={props.obj.item ? __.edit + __.image : __.create + __.image}
        visible={state.visible}
        onCancel={this.onCancel}
        onConfirm={this.onCreateImage}>
        <div className="modal-bd halo-com-modal-create-image">
          <div className="content-wrapper">
            ...
            <div className="modal-content">
              <ImageInfo ref="image_info" displayKey={state.displayKey} type={props.obj.type} item={state.item} changeType={this.changeType} onChangeName={this.onChangeName}/>
